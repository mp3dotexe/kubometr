...
` + chat.ButtonSubmit + ` — менеджер перезвонит и уточнит цены, наличие и доставку. В заявку попадёт итоговый список из нашего диалога, а номер телефона Telegram попросит подтвердить.
